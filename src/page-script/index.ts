...
// biome-ignore lint/style/useConst: bridgeChannel is reassigned dynamically during page initialization
let bridgeChannel: string | null = null;
// biome-ignore lint/style/useConst: bridgeNonce is reassigned dynamically during page initialization
